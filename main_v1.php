	...
	<aside id="barraLateral">
        ...
        <section id="barra de busqueda"  style="width:100%">
         <form id="searchformMain">
            ...
            <button  type="submit" class="backend" onclick="LLAMAR COOKIES" value="">Añadir el producto (ENTER)</button>
            <button type=button class="backend" onclick= "toBusqueda()"> Buscar un producto</button>
            </div>
            </form>
        </section>
